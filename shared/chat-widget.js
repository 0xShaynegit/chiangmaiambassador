(function () {
  ...
  panel.innerHTML = `
    <div id="cml-chat-head"><span>Ask Chiang Mai Ambassador</span><button id="cml-chat-reset" type="button">Reset</button></div>
    <div id="cml-chat-log"></div>
    <div id="cml-chat-chips"></div>
    <form id="cml-chat-form">
      <input id="cml-chat-input" type="text" placeholder="Ask about Chiang Mai..." autocomplete="off" />
